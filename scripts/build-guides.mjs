...
const GUIDES = [
  {
    ...
    <div class="disclaimer">
      <p><strong>Cara membaca data ini (penting).</strong> <strong>Harga, rating, dan jumlah ulasan</strong> di tabel adalah data <strong>nyata</strong> dari listing Shopee. Kolom <strong>estimasi omzet/bulan</strong> adalah <strong>estimasi LarisID</strong> (dihitung dari estimasi kecepatan penjualan × harga) sebagai <em>skala</em>, <em>bukan data resmi Shopee</em> — angka "terjual" di Shopee sendiri adalah estimasi. Di aplikasi, omset juga ditampilkan <strong>per minggu</strong>, bukan hanya per bulan. Gunakan omzet estimasi untuk membaca skala pasar, bukan angka pasti. Metodologinya kami jelaskan terbuka di <a href="/cara-kerja/">cara kerja</a>.</p>
    </div>
