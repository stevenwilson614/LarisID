...
function buildSitemap(entries) {
  ...
  const staticUrls = [
    ...
    { loc: `${SITE}/panduan/produk-terlaris-untuk-pemula-2026/`, freq: 'monthly', pri: '0.8', mod: SNAPSHOT },
    ...
    { loc: `${SITE}/kalkulator/`, freq: 'monthly', pri: '0.8', mod: SNAPSHOT },
    { loc: `${SITE}/kalkulator/margin-hpp/`, freq: 'monthly', pri: '0.75', mod: SNAPSHOT },
    { loc: `${SITE}/kalkulator/biaya-shopee/`, freq: 'monthly', pri: '0.75', mod: SNAPSHOT },
