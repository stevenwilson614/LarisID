...
| Edukasi | `#btn-edukasi`, `#view-edukasi`, `#edu-interest-capture` | Logged-in interest yes (name required; missing email or WhatsApp). Popup finishes on the current page; Nanti skips that browser. Not onboarding. Hidden for mentors/admins and people already in a cohort. |
