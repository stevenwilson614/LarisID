-- Wire get_tracker_rollup's has_history onto the window-independent helper
-- added in 20260803120000_tracker_has_history.sql. Body is otherwise the live
-- definition, dumped from prod with pg_get_functiondef and patched in one place.
